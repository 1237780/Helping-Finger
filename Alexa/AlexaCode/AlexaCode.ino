/**********************************************************************************
 *  TITLE: Manual + Alexa control 4 channel Relay Module using NodeMCU or ESP32
 *  Click on the following links to learn more. 
 *  YouTube Video: https://youtu.be/OJ4CzWyRQr4
...
// device names
String Device_1_Name = "Audi";
String Device_2_Name = "VW";
String Device_3_Name = "Porsche";
String Device_4_Name = "Mercedes";
